...
Репозиторий — собранные лабораторные и проекты по учёбе. Ниже — что по смыслу проходит через эти работы (по папкам семестров и курсов):
...
Не все отчёты сохранились из-за сбоев; в репозитории — часть работ. В папке MegaSchool — материалы олимпиады/ивента МегаШкола ИТМО.
